...
const schema = yup.object().shape({
  email: yup.string().min(7,'Mail must be at least 3 characters').max(254,'Mail should not exceed 254 characters').required("Mandatory field").email('Електронна адреса має бути дійсною'),
